...
CREATE TABLE `tbl_membership` (
  ...
  KEY `FK_member_membership_01_idx` (`Id`),
  CONSTRAINT `FK_member_membership_01` FOREIGN KEY (`Id`) REFERENCES `tbl_member` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-07-05 13:08:11
